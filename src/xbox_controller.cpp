...
void XboxController::processAppleInput(IOHIDValueRef value) {
    ...
    switch (usagePage) {
        case kHIDPage_GenericDesktop:
            switch (usage) {
                case kHIDUsage_GD_X: currentState_.leftStickX = intValue; break;
                case kHIDUsage_GD_Y: currentState_.leftStickY = intValue; break;
                case kHIDUsage_GD_Z: currentState_.rightStickX = intValue; break;
                case kHIDUsage_GD_Rz: currentState_.rightStickY = intValue; break;
        ...
        case kHIDPage_Button:
            switch (usage) {
                case 1: currentState_.buttonA = (intValue != 0); break;
                case 2: currentState_.buttonB = (intValue != 0); break;
                case 3: currentState_.buttonX = (intValue != 0); break;
                case 4: currentState_.buttonY = (intValue != 0); break;
                case 5: currentState_.buttonLB = (intValue != 0); break;
                case 6: currentState_.buttonRB = (intValue != 0); break;
                case 7: currentState_.buttonBack = (intValue != 0); break;
                case 8: currentState_.buttonStart = (intValue != 0); break;
                case 9: currentState_.buttonLeftStick = (intValue != 0); break;
                case 10: currentState_.buttonRightStick = (intValue != 0); break;
            }
            break;
            
        case kHIDPage_Simulation:
            switch (usage) {
                case kHIDUsage_Sim_Accelerator: currentState_.rightTrigger = intValue; break;
                case kHIDUsage_Sim_Brake: currentState_.leftTrigger = intValue; break;
            }
            break;
    }
}
    ...
    switch (event.type) {
        case JS_EVENT_BUTTON:
            if (event.number < 11) {
                ...
                switch (event.number) {
                    case 0: currentState_.buttonA = pressed; break;
                    case 1: currentState_.buttonB = pressed; break;
                    case 2: currentState_.buttonX = pressed; break;
                    case 3: currentState_.buttonY = pressed; break;
                    case 4: currentState_.buttonLB = pressed; break;
                    case 5: currentState_.buttonRB = pressed; break;
                    case 6: currentState_.buttonBack = pressed; break;
                    case 7: currentState_.buttonStart = pressed; break;
                    case 8: currentState_.buttonLeftStick = pressed; break;
                    case 9: currentState_.buttonRightStick = pressed; break;
                }
            }
            break;
        ...
        case JS_EVENT_AXIS:
            if (event.number < 6) {
                // Map axes
                switch (event.number) {
                    case 0: currentState_.leftStickX = event.value; break;
                    case 1: currentState_.leftStickY = event.value; break;
                    case 2: currentState_.rightStickX = event.value; break;
                    case 3: currentState_.rightStickY = event.value; break;
                    case 4: currentState_.leftTrigger = (event.value + 32768) / 256; break;
                    case 5: currentState_.rightTrigger = (event.value + 32768) / 256; break;
                }
            }
            break;
    }
